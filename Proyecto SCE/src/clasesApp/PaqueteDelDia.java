...
public class PaqueteDelDia extends Producto implements IContable, Serializable {
    ...
    public PaqueteDelDia(int bebida) {// el precio de este sera el costo del
                                      // plato del dia + 5 guarnicion+ precio de
                                      // la bebida
        super(8);
        platofuerte = new Preparado(9);
    ...
    public PaqueteDelDia(int bebida, int guanicion) {// el precio de este sera
                                                     // el costo del plato del
                                                     // dia + 5 guarnicion+
                                                     // precio de la bebida
        super(8);
        platofuerte = new Preparado(9);
